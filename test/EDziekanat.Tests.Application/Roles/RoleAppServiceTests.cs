...
using EDziekanat.Application.Roles;
...
namespace EDziekanat.Tests.Application.Roles
{
    public class RoleAppServiceTests : ApplicationTestBase
    {
        ...
        public async void Should_Remove_Role()
        {
            ...
            dbContextFromAnotherScope = GetNewScopeServiceProvider().GetService<EDziekanatDbContext>();
